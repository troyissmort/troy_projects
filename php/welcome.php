...
<head>
    ...
    <title>Welcome to Troy Bakes- <?php echo $_SESSION['email'] ?></title>
</head>
<!--
    <span>
...
<body>
    ...
    -->
    <h2>
        Welcome to Troy Bakes- <?php echo $_SESSION['email'] ?>
    </h2>
    <p>Use this site to check our partners and supplied items </p>
</body>
